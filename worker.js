...
var COMPANIES = [
  ...
  {id:848,name:"Almac Group",location:"Craigavon, United Kingdom",platform:"NeoPeptides™ Individualised Cancer Vaccine Manufacturing",summary:"Almac's NeoPeptides platform provides fully GMP-compliant manufacture of individualised neoantigen peptide vaccines — releasing a full patient-specific peptide set in under three weeks from an MHRA-registered facility.",description:"Neoantigen-derived vaccines are a major new strategy in oncology, harnessing the immune system to fight cancer using a patient's own unique tumour mutations. Almac's NeoPeptides platform manufactures the 10-30 peptides representing each patient's neoepitopes, with each peptide manufactured once and administered to only that single patient. The MHRA-registered facility and bespoke Pharmaceutical Quality System enable full GMP compliant manufacture and release within less than three weeks — a track record backed by positive regulatory reviews from both European and US authorities.",keywords:["Individualised Cancer Vaccine","Neoantigen Peptides","GMP Peptide Manufacture","Oncology","Personalised Medicine"],tags:["ai"],badge:"Peptide Manufacturing Platform",badgeClass:"badge-antibody",seeking:"Partnership · Co-Development",geo:"europe"}
];
